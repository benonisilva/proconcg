(function() {
    ...
    CameraCtrl.$inject = ['$scope','$timeout','CameraService','ArquivosFactory'];

    /*Def do controller*/
    function CameraCtrl($scope,$timeout,CameraService,ArquivosFactory) { 
    	var vm = this;
    	console.log("init CameraCtrl");

    }
})();

/*angular.module('', [])
.controller('CameraCtrl', ['$scope', '$location', 'GetUU',
